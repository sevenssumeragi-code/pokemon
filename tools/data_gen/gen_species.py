...
# 4 ムニ フェアリー 平均低め
sp("muni","ムニ",["fairy"],75,50,70,85,80,80,"prankster",num=4,weight=4.5,height=0.4,catch_rate=190,base_exp=90,ev_yield={"spe":1},
...
sp("gel","ゲル",["ice"],70,60,70,120,80,110,"snow_warning",num=5,weight=32.0,height=1.1,catch_rate=60,base_exp=170,ev_yield={"spa":2},
   ...
   tm=COMMON_TM+["psychic","dazzling_gleam","shadow_ball","energy_ball","surf","hydro_pump","nasty_plot","light_screen","reflect","thunder_wave","icy_wind","water_pulse","weather_ball","hyper_voice","snore","taunt","encore","tri_attack","recover","yawn","rain_dance","psyshock","flash_cannon","ice_spinner","avalanche","earth_power","chilling_water","haze"],
...
# 8 マルタン ひこう B/D
sp("marutan","マルタン",["flying"],95,60,115,80,115,65,"sacred_light",num=8,weight=28.0,height=1.3,catch_rate=60,base_exp=170,ev_yield={"spd":1,"def":1},
...
# 14 ムニR竜 ドラゴン
sp("muni_r_dragon","ムニ（竜）",["dragon"],80,80,75,60,75,70,"multiscale",num=14,weight=9.0,height=0.5,base_form="muni",form="R竜",catch_rate=120,base_exp=100,ev_yield={"hp":1},
...
# 16 ムニRノ ノーマル
sp("muni_r_normal","ムニ（ノ）",["normal"],80,60,75,60,80,85,"minimal_body",num=16,weight=5.0,height=0.3,base_form="muni",form="Rノ",catch_rate=120,base_exp=100,ev_yield={"spd":1},
