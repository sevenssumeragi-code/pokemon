...
# 2 ジンパチ ほのお A/S
sp("jinpachi","ジンパチ",["fire"],70,115,70,80,70,115,"flame_domain",num=2,weight=55.0,height=1.5,catch_rate=45,base_exp=175,ev_yield={"spe":2},
   ...
   tm=COMMON_TM+["u_turn","close_combat","earthquake","iron_head","wild_charge","thunder_punch","play_rough","crunch","knock_off","bulk_up","taunt","roar","flamethrower","fire_blast","solar_beam","psychic_fangs","low_kick","brick_break","stone_edge","rock_slide","extreme_speed","fake_out","trailblaze","body_slam","double_edge","snore","scorching_sands","zen_headbutt","heat_crash","agility","work_up","torch_song"],
   dex="周囲の空気を自身の炎の領域に変えてしまう。仲間の炎まで激しく燃え上がらせる。")
# 3 ヒュウ ゴースト C/S
sp("hyu","ヒュウ",["ghost"],70,50,65,120,80,115,"dark_domain",num=3,weight=12.0,height=1.2,catch_rate=45,base_exp=175,ev_yield={"spa":2},
   ...
   tm=COMMON_TM+["thunderbolt","energy_ball","psychic","sludge_bomb","focus_blast","dazzling_gleam","taunt","trick","calm_mind","disable","haze","icy_wind","thunder_wave","hypnosis","psyshock","giga_drain","shadow_punch","knock_off","sucker_punch","memento","trick_room","nightmare","dream_eater","snore","ominous_wind","hyper_voice","shadow_bone"],
   dex="夜の闇そのものを身にまとう。その領域の中では亡霊の力が何倍にもふくれあがる。")
# 4 ムニ フェアリー 平均低め
sp("muni","ムニ",["fairy"],65,55,70,70,75,85,"prankster",num=4,weight=4.5,height=0.4,catch_rate=190,base_exp=90,ev_yield={"spe":1},
   ...
   tm=COMMON_TM+["taunt","will_o_wisp","psychic","thunderbolt","shadow_ball","calm_mind","yawn","heal_bell","baton_pass","safeguard","stored_power","psych_up","helping_hand","trick","knock_off","u_turn","energy_ball","mystical_fire","icy_wind","charge_beam","snore","fake_tears","tickle","screech","confuse_ray","hyper_voice","work_up","body_slam","spirit_break"],
   dex="小さないたずら好き。相手が動く前にちょこまかと動き回り、姿を小さくして攻撃をかわす。")
# 5 ゲル こおり C/S
sp("gel","ゲル",["ice"],70,60,70,120,80,110,"snow_warning",num=5,weight=32.0,height=1.1,catch_rate=60,base_exp=170,ev_yield={"spa":2},
   ...
   tm=COMMON_TM+["thunderbolt","psychic","dazzling_gleam","shadow_ball","energy_ball","focus_blast","surf","hydro_pump","nasty_plot","light_screen","reflect","thunder_wave","icy_wind","water_pulse","weather_ball","hyper_voice","snore","taunt","encore","tri_attack","recover","yawn","rain_dance","psyshock","flash_cannon","ice_spinner","avalanche","earth_power","chilling_water","haze"],
   dex="現れると周囲に雪を降らせる。雪の中では体表が硬く凍りつき、吹雪を自在に操る。")
# 6 ネオ かくとう A/C (進化前)
sp("neo","ネオ",["fighting"],55,85,50,80,50,80,"sharpness",hidden="steadfast",num=6,weight=20.0,height=0.9,nfe=True,evolution={"method":"level","level":34,"into":"trans"},catch_rate=120,base_exp=80,ev_yield={"atk":1},
...
# 8 マルタン ひこう B/D
sp("marutan","マルタン",["flying"],85,60,120,70,120,65,"sacred_light",num=8,weight=28.0,height=1.3,catch_rate=60,base_exp=170,ev_yield={"spd":1,"def":1},
...
# 9 なまずお でんき/はがね
sp("namazuo","なまずお",["electric","steel"],70,115,85,60,70,110,"static",num=9,weight=60.0,height=1.2,catch_rate=60,base_exp=170,ev_yield={"atk":2},
   ...
   tm=COMMON_TM+["volt_switch","thunderbolt","thunder","steel_beam","flash_cannon","aqua_cutter","psycho_cut","sacred_sword","leaf_blade","stone_axe","ceaseless_edge","aerial_ace","air_cutter","knock_off","crunch","earthquake","rock_slide","stone_edge","brick_break","body_press","bulk_up","taunt","electric_terrain","magnet_rise","gyro_ball","heavy_slam","thunder_punch","ice_punch","fire_punch","snore","agility","u_turn","razor_shell","x_scissor","electroweb","charge"],
   dex="鋼のひげに静電気をため込む。触れた者はしびれてしまう。")
# 10 ほねばみ はがね/ひこう
sp("honebami","ほねばみ",["steel","flying"],65,115,75,55,70,120,"unburden",num=10,weight=18.0,height=1.0,catch_rate=60,base_exp=170,ev_yield={"spe":2},
   level=[(1,"peck"),(1,"leer"),(5,"metal_claw"),(9,"quick_attack"),(13,"wing_attack"),(17,"cut"),(21,"steel_wing"),(25,"aerial_ace"),(29,"slash"),(33,"swords_dance"),(37,"air_cutter"),(41,"iron_head"),(45,"night_slash"),(49,"acrobatics"),(53,"brave_bird"),(57,"smart_strike"),(61,"kowtow_cleave")],
   tm=COMMON_TM+["u_turn","tailwind","roost","knock_off","x_scissor","psycho_cut","sacred_sword","stone_axe","ceaseless_edge","aqua_cutter","leaf_blade","dual_wingbeat","drill_peck","fly","rock_slide","stone_edge","body_press","iron_defense","taunt","defog","brick_break","low_kick","agility","steel_beam","flash_cannon","bullet_punch","snore","air_slash","hurricane","feather_dance","heavy_slam"],
   dex="骨のように軽い鋼の翼を持つ。荷物を捨てると風のような速さで飛び回る。")
# 11 ジンパチR いわ
sp("jinpachi_r","ジンパチ（リージョン）",["rock"],80,120,90,55,110,50,"sturdy",num=11,weight=130.0,height=1.6,base_form="jinpachi",form="R",catch_rate=45,base_exp=175,ev_yield={"atk":2},
...
# 12 ヒュウR くさ
sp("hyu_r","ヒュウ（リージョン）",["grass"],65,55,65,120,80,115,"contrary",num=12,weight=10.0,height=1.2,base_form="hyu",form="R",catch_rate=45,base_exp=175,ev_yield={"spa":2},
   ...
   tm=COMMON_TM+["shadow_ball","psychic","dazzling_gleam","sludge_bomb","overheat","draco_meteor","superpower","close_combat","earth_power","knock_off","taunt","trick","hyper_voice","seed_bomb","grass_knot","stun_spore","light_screen","reflect","calm_mind","nasty_plot","hex","will_o_wisp","psyshock","weather_ball","snore","sunny_day","trailblaze","icy_wind","confuse_ray","leaf_tornado","struggle_bug","snarl","armor_cannon"],
...
sp("renny_r","レニィ（リージョン）",["fairy"],105,115,80,55,75,80,"pixilate",num=13,weight=70.0,height=1.4,base_form="renny",form="R",catch_rate=45,base_exp=175,ev_yield={"atk":2},
   level=[(1,"tackle"),(1,"leer"),(4,"fairy_wind"),(8,"quick_attack"),(12,"bite"),(16,"headbutt"),(20,"play_rough"),(24,"yawn"),(28,"body_slam"),(32,"rest"),(36,"crunch"),(40,"take_down"),(44,"hyper_voice"),(48,"double_edge"),(52,"extreme_speed"),(56,"sleep_talk"),(60,"boomburst")],
   tm=COMMON_TM+["ice_fang","ice_punch","earthquake","stone_edge","rock_slide","superpower","body_press","iron_head","bulk_up","knock_off","snore","brick_break","low_kick","zen_headbutt","heavy_slam","curse","taunt","roar","giga_impact","mega_kick","strength","retaliate","spirit_break","wish","charm","fire_fang","thunder_fang","drain_punch","fake_out","hyper_fang","population_bomb","slash","false_swipe"],
   dex="妖精の加護を受けた姿。放つ突進は妖精の光をまとい、竜すら退ける。")
# 14 ムニR竜 ドラゴン
sp("muni_r_dragon","ムニ（竜）",["dragon"],70,70,70,70,70,70,"multiscale",num=14,weight=9.0,height=0.5,base_form="muni",form="R竜",catch_rate=120,base_exp=100,ev_yield={"hp":1},
   ...
   tm=COMMON_TM+["thunderbolt","flamethrower","ice_beam","earthquake","iron_head","u_turn","taunt","encore","wish","baton_pass","calm_mind","stored_power","body_slam","play_rough","knock_off","aqua_tail","iron_tail","fire_fang","thunder_fang","ice_fang","snore","agility","work_up","hyper_voice","fire_punch","thunder_punch","psych_up","helping_hand"],
   dex="小さな竜の鱗をまとった姿。傷ひとつない鱗は、どんな攻撃の勢いも半分に殺してしまう。")
# 15 ムニR虫 むし
sp("muni_r_bug","ムニ（虫）",["bug"],65,50,60,80,75,90,"compound_eyes",num=15,weight=3.0,height=0.4,base_form="muni",form="R虫",catch_rate=120,base_exp=100,ev_yield={"spa":1},
   ...
   tm=COMMON_TM+["psychic","shadow_ball","giga_drain","u_turn","tailwind","roost","light_screen","reflect","safeguard","thunder_wave","draining_kiss","dazzling_gleam","baton_pass","encore","taunt","sticky_web","infestation","hyper_voice","snore","icy_wind","electroweb","calm_mind","stored_power","psych_up","substitute","skitter_smack","pounce","leech_life"],
   dex="複眼を持つ虫の姿。粉を撒く技を確実に当て、舞い踊るたびに強くなる。")
# 16 ムニRノ ノーマル
sp("muni_r_normal","ムニ（ノ）",["normal"],70,60,70,60,75,85,"minimal_body",num=16,weight=5.0,height=0.3,base_form="muni",form="Rノ",catch_rate=120,base_exp=100,ev_yield={"spd":1},
