...
# 6 ネオ かくとう A/C (進化前)
sp("neo","ネオ",["fighting"],60,100,55,60,55,90,"sharpness",hidden="steadfast",num=6,weight=20.0,height=0.9,nfe=True,evolution=[{"method":"level","level":34,"into":"trans"},{"method":"item","item":"mind_stone","into":"trans_r"}],catch_rate=120,base_exp=80,ev_yield={"atk":1},
...
# 19 トランスR エスパー
sp("trans_r","トランス（リージョン）",["psychic"],90,115,75,110,75,75,"competitive",num=19,weight=80.0,height=1.8,base_form="trans",form="R",evolves_from="neo",catch_rate=45,base_exp=190,ev_yield={"atk":2,"spa":1},
