...
- [ ] 自動通しテスト（tests/rpg_playthrough.gd / run_playthrough.sh）: ボス戦まで到達、クリア確認中
...
## 次の具体的タスク3つ
1. 通しテスト（新規→ボス撃破→エンディング）を安定して PLAYTHROUGH_OK にする（ボス難易度・ボット調整）
2. Xvfb スクリーンショットで探索画面・メニュー・会話の見た目を確認し調整
3. Phase 5: ダブルバトル（対象選択UI/AI、味方対象技、(c)検証）
