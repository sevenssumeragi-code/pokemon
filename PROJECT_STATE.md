...
- [x] シミュレーター mode=doubles（4体チーム）— (c) 検証 8000戦を実行中（reports/balance_r10_doubles.md 予定）
...
## 次の具体的タスク3つ
1. (c) ダブル検証レポートを読み、炎の領域・やみのりょういき・いかくのダブルでの発動と勝率を確認（必要なら BALANCE_LOG に記録して調整）
