...
## 次の具体的タスク3つ
1. Phase 5: ダブルバトルのエンジン検証テスト（全体技0.75倍、味方対象、炎の領域/やみのりょういきの味方適用、いかくの2体効果、片側ひんし交代）
2. ダブル用シミュレーション (c)（mode=doubles）とレポート、UIの対象選択
3. マップ・ストーリー追加（町2、ジム的施設、ダブルバトルのトレーナー）
